...
export const projects: Project[] = [
  ...
  },
  {
    ...
    problem: '',
    built:
      "A self-learning, fee-aware auto-trader for Kalshi's 15-minute Bitcoin binary markets — four strategies behind an anti-overfitting gate, hard risk limits, and a live dashboard, running 24/7 on Fly.io. Paper-trading by default with a real broker path.",
    metrics: [],
    stack: ['Python', 'Kalshi API', 'FastAPI', 'Fly.io'],
    links: [{ label: 'GitHub', href: GH }],
    shot: '',
    featured: false,
  },
